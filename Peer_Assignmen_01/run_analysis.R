...
# activities in the data set Appropriately 
# labels the data set with descriptive variable 
# names. 
#
...
#-------------------------------------------------
# Step 1: Merges the training and the test sets to 
# create one data set.
#-------------------------------------------------
...
#-------------------------------------------------
# Step 5: Creates a second, independent tidy data 
